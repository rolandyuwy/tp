...
1. The command execution can affect the `Model` (e.g. adding a food).
...
| `* * *`  | tech-savvy food                          | be able to use more intuitive commands  | be more comfortable with using the product                    |
...
| `*`      | food on a diet                           | know how much calories is in the meal I prepared | keep to my diet                                      |
