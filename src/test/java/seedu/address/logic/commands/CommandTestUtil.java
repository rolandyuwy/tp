...
public class CommandTestUtil {
    ...
    public static final String INVALID_DESCRIPTION_DESC = " " + PREFIX_DESCRIPTION + "James&"; // '&' not allowed in names
    ...
    public static final EditCommand.EditPersonDescriptor DESC_APPLE_PIE;
    public static final EditCommand.EditPersonDescriptor DESC_BREAD;

    static {
        DESC_APPLE_PIE = new EditPersonDescriptorBuilder().withDescription(VALID_DESCRIPTION_APPLE_PIE)
                .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BREAD = new EditPersonDescriptorBuilder().withDescription(VALID_DESCRIPTION_BREAD)
