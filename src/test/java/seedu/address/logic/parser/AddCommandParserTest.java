...
import static seedu.address.logic.commands.CommandTestUtil.DESCRIPTION_DESC_APPLE_PIE;
import static seedu.address.logic.commands.CommandTestUtil.DESCRIPTION_DESC_BREAD;
...
import static seedu.address.testutil.TypicalPersons.APPLE_PIE;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Person expectedPerson = new PersonBuilder(BREAD).withTags(VALID_TAG_FRIEND).build();
        ...
        Person expectedPersonMultipleTags = new PersonBuilder(BREAD).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND)
                .build();
    ...
    public void parse_optionalFieldsMissing_success() {
        // zero tags
        Person expectedPerson = new PersonBuilder(APPLE_PIE).withTags().build();
