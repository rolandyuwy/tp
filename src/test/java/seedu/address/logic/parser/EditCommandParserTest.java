...
public class EditCommandParserTest {
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withPriority(VALID_PRIORITY_BOB).build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
        ...
        userInput = targetIndex.getOneBased() + EMAIL_DESC_BOB + INVALID_PRIORITY_DESC + ADDRESS_DESC_BOB
                + PRIORITY_DESC_BOB;
        descriptor = new EditPersonDescriptorBuilder().withPriority(VALID_PRIORITY_BOB).withEmail(VALID_EMAIL_BOB)
